getgenv().DoughKing = function()
    local url = 'http://fi4.bot-hosting.net:22869/BloxFruiTWebHooksDoughtKingV2?webhok=https://discord.com/api/webhooks/1358397054853845053/PFxIawpRpct5oNzsocjG0E48RpZGVc86FFi2PZQmgc99pmSRjHBcqsW2azKupx6yjgSX'
    local chooses
